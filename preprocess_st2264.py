...
INPUT_OUTPUT_PATHS = (
    (
        ROOT / "Data" / "sort_data" / "2024_data_ST-2264.parquet",
        ROOT / "Data" / "sort_data" / "preprocessed_6station" / "ST-2264.csv",
    ),
    (
        ROOT / "Data" / "sort_data" / "2025_data_ST-2264.parquet",
        ROOT / "Data" / "sort_data" / "preprocessed_6station" / "ST-2264_2025.csv",
    ),
)
KOREA_HOLIDAYS = {
    "2024-01-01",
